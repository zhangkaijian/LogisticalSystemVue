      ...
      <div style="padding-right: 77px;">
        <el-form ref="truck" label-width="80px" :moderl="truck">
          ...
          <el-form-item>
            ...
            <el-button type="primary" v-if="flag=='修改车辆信息'" @click="updateTruck">修改</el-button>
            <el-button type="primary" v-if="flag=='添加车辆信息'" @click="doAddTruck">添加</el-button>
          </el-form-item>
        </el-form>
      </div>
    </el-dialog>
...
<script>
    export default {
      ...
      methods:{
        ...
        initTrucks(){
          let url = '/truck/?type='+this.truckTypes+'&size='+this.pageSize+'&page='+this.currentPage+'&filed='+this.filed;
          if (this.daterange) {
